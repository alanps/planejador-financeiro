		...
		<tbody>
			...
			<tr>
				<td style="padding-bottom:30px">
					...
					<center><div style="font-size: 11px;">Olá <a href="" style="font-family: 'Verdana'; display: inline; margin: 0 auto; text-align: center; font-size: 11px; color: #487ab9; text-decoration: none; width: 250px;">{{ $nome }}</a>!</div></center>
					<br><br>
	  				<center><div style="color: #000000; font-size: 11px; width: 430px; line-height: 19px;">Voce solicitou a redefinição da sua senha, você pode mudar ela pelo seu perfil no aplicativo, abaixo esta a sua nova senha gerada randomicamente.</div></center>
					<br><br>
					<div style="font-size: 11px;">Sua nova senha:</div>
					<br>
					<table width="465" align="center" cellpadding="0" cellspacing="0" border="0" style="font-family: 'Verdana'; color:#000000; text-align:center; background-color: #f4f4f4 !important; border: 1px solid rgba(0, 0, 0, 0.1);">
						<tbody>
							...
							<tr>
								<td style="border-bottom: 1px solid rgba(0, 0, 0, 0.10); border-top: 1px solid rgba(0, 0, 0, 0.10); width: 100%; padding: 6px;">
									<div style="font-family: 'Verdana'; font-size: 11px; text-align: center; color: #487ab9">{{ $password }}</div>
								</td>
							</tr>
							<tr>
								<td style="padding: 4px;">
